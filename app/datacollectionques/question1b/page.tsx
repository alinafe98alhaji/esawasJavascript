...
const SurveyPage = () => {
  ...
  const questions = [
    {
      id: "1b",
      text:
        "1.b: Is your organisation aware of a process for ensuring that data is collected universally/inclusively across the country?"
    },
    {
      id: "1bi",
      text:
    ...
    },
    {
      id: "1bii",
      text:
        "1.b.(ii): How effective is this process at ensuring that data is collected universally and inclusively?"
    },
    {
      id: "1biii",
      text:
        "1.b.(iii): Why is the nationally mandated process for data collection not more effective at ensuring universal and inclusive data collection?"
    },
    {
      id: "1biv",
      text:
        "1.b.(iv): Why does your organisation not collect data in line with this process?"
    },
    {
      id: "submit",
  ...
  const renderCustomQuestionInputs = (
    ...
    if (questionId === "1biii" || questionId === "1biv") {
  ...
  const handleNext = () => {
    ...
    if (currentQuestion.id === "1b") {
    ...
    } else if (currentQuestion.id === "1bi") {
      if (!validateYesNoResponses(activeAreas)) {
        setError("Please select Yes or No for all areas.");
        return;
      }
    ...
    } else if (currentQuestion.id === "1bii") {
      ...
      currentQuestion.id === "1biii" &&
      !validateFiveOptionResponses(finalAreas1aiii)
    ) {
      setError("Please select an option for all areas.");
      return;
    } else if (
      currentQuestion.id === "1biv" &&
  ...
  const renderQuestion = () => {
    ...
    return (
      ...
      >
        ...
        {currentQuestion.id === "1b" && renderYesNoRadios(activeAreas)}
        {currentQuestion.id === "1bi" && renderYesNoRadios(activeAreas)}
        {currentQuestion.id === "1bii" &&
          ...
          <div>
            ...
            <div className="flex gap-30 items-bottom flex-col sm:flex-row justify-right">
              <a
                ...
                href="/datacollectionques/question1c" // Link to your survey page
