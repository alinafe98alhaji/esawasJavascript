...
const SurveyPage = () => {
  ...
  const questions = [
    {
      id: "4b",
      text:
        "4.b: Is your organisation aware of centrally coordinated programs for data quality improvement?"
    },
    {
      id: "4bi",
      text:
        "4.b.(i): Does your organisation participate in centrally coordinated programs for data quality improvement?"
    },
    {
      id: "4bii",
      text:
        "4.b.(ii): How effective have these programs been in improving data quality?"
    },
    {
      id: "4biii",
      text:
        "4.b.(iii): Why are centrally coordinated programmes not more effective at improving data quality?"
    },
    {
      id: "4biv",
      text:
        "4.b.(iv): Why does your organisation not participate in centrally coordinated programs for data quality improvement?"
    },
    {
      id: "submit",
  ...
  const renderCustomQuestionInputs = (
    ...
    if (questionId === "4biii" || questionId === "4biv") {
  ...
  async function submitResponses(formData: any) {
    ...
    try {
      const res = await fetch("/api/dqpost", {
        method: "POST",
        headers: {
  ...
  const handleNext = () => {
    ...
    if (currentQuestion.id === "4b") {
    ...
    } else if (currentQuestion.id === "4bi") {
      if (!validateYesNoResponses(activeAreas)) {
        setError("Please select Yes or No for all areas.");
        return;
      }
    ...
    } else if (currentQuestion.id === "4bii") {
      ...
      currentQuestion.id === "4biii" &&
      !validateFiveOptionResponses(finalAreas1aiii)
    ) {
      setError("Please select an option for all areas.");
      return;
    } else if (
      currentQuestion.id === "4biv" &&
  ...
  const renderQuestion = () => {
    ...
    return (
      ...
      >
        ...
        {currentQuestion.id === "4b" && renderYesNoRadios(activeAreas)}
        {currentQuestion.id === "4bi" && renderYesNoRadios(activeAreas)}
        {currentQuestion.id === "4bii" &&
          ...
          <div>
            ...
            <div className="flex gap-30 items-bottom flex-col sm:flex-row justify-right">
              <a
                ...
                href="/datausage" // Link to your survey page
