...
const SurveyPage = () => {
  ...
  const questions = [
    {
      id: "3b",
      text:
        "3.b: Is your organisation aware of central platforms for helping share and manage data easily?"
    },
    {
      id: "3bi",
      text:
        "3.b.(i): Does your organisation make use of centralised platforms share data?"
    },
    {
      id: "3bii",
      text:
        "3.b.(ii): How effective are these centralised platforms in facilitating data sharing?"
    },
    {
      id: "3biii",
      text:
        "3.b.(iii): Why are centralised platforms not always fully effective at facilitating data sharing?"
    },
    {
      id: "3biv",
      text:
        "3.b.(iv): Why does your organisation not make use of centralised platforms to facilitate data sharing?"
    },
    {
      id: "submit",
  ...
  const renderCustomQuestionInputs = (
    ...
    if (questionId === "3biii" || questionId === "3biv") {
  ...
  const handleNext = () => {
    ...
    if (currentQuestion.id === "3b") {
    ...
    } else if (currentQuestion.id === "3bi") {
      if (!validateYesNoResponses(activeAreas)) {
        setError("Please select Yes or No for all areas.");
        return;
      }
    ...
    } else if (currentQuestion.id === "3bii") {
      ...
      currentQuestion.id === "3biii" &&
      !validateFiveOptionResponses(finalAreas1aiii)
    ) {
      setError("Please select an option for all areas.");
      return;
    } else if (
      currentQuestion.id === "3biv" &&
  ...
  const renderQuestion = () => {
    ...
    return (
      ...
      >
        ...
        {currentQuestion.id === "3b" && renderYesNoRadios(activeAreas)}
        {currentQuestion.id === "3bi" && renderYesNoRadios(activeAreas)}
        {currentQuestion.id === "3bii" &&
          ...
          <div>
            ...
            <div className="flex gap-30 items-bottom flex-col sm:flex-row justify-right">
              <a
                ...
                href="/dataopenessandflow/question3c" // Link to your survey page
