...
const SurveyPage = () => {
  ...
  const questions = [
    {
      id: "5d",
      text:
        "5.d: Is your organisation aware of a formalised holistic approach to training and capacity building for data-related aspects in the WSS sector?"
    },
    {
      id: "5di",
      text:
        "5.d.(i): Does your organisation participate in these capacity building/training programmes?"
    },
    {
      id: "5dii",
      text:
        "5.d.(ii): How effective are these capacity building/training programmes at improving data literacy in your organisation?"
    },
    {
      id: "5diii",
      text:
        "5.d.(iii): How could these capacity building/training programmes be more effective at improving data literacy in your organisation?"
    },
    {
      id: "5div",
      text:
        "5.d.(iv): Why does your organisation not participate in these capacity building/training programmes?"
    },
    {
      id: "submit",
  ...
  const renderCustomQuestionInputs = (
    ...
    if (questionId === "5diii" || questionId === "5div") {
  ...
  async function submitResponses(formData: any) {
    ...
    try {
      const res = await fetch("/api/dupost", {
        method: "POST",
        headers: {
  ...
  const handleNext = () => {
    ...
    if (currentQuestion.id === "5d") {
    ...
    } else if (currentQuestion.id === "5di") {
      if (!validateYesNoResponses(activeAreas)) {
        setError("Please select Yes or No for all areas.");
        return;
      }
    ...
    } else if (currentQuestion.id === "5dii") {
      ...
      currentQuestion.id === "5diii" &&
      !validateFiveOptionResponses(finalAreas1aiii)
    ) {
      setError("Please select an option for all areas.");
      return;
    } else if (
      currentQuestion.id === "5div" &&
  ...
  const renderQuestion = () => {
    ...
    return (
      ...
      >
        ...
        {currentQuestion.id === "5d" && renderYesNoRadios(activeAreas)}
        {currentQuestion.id === "5di" && renderYesNoRadios(activeAreas)}
        {currentQuestion.id === "5dii" &&
